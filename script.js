const tasks = [
    { question: "Ich war ___ Kino.", answer: "im" },
    { question: "Warst du heute schon ___ Supermarkt?", answer: "im" },
    { question: "Ich war ___ mein___ Freundin.", answer: "bei meiner" },
    { question: "Ich wohne ___ Langstraße.", answer: "in der" },
    { question: "Ich war gerade ___ Bäckerei.", answer: "in der" },
    { question: "Gestern war ich ___ Arzt.", answer: "beim" },
    { question: "Am Vormittag ist Sara ___ Schule.", answer: "in der" },
    { question: "Am Samstag sind wir ___ Park spazieren gegangen.", answer: "im" },
    { question: "Ich bin gerade ___ Antonio.", answer: "bei" },
    { question: "Meine Tante wohnt ___ Schweiz.", answer: "in der" },
    { question: "Sara wohnt noch ___ ihr___ Eltern.", answer: "bei ihren" },
    { question: "Ich bin gerade ___ Deutschkurs.", answer: "im" },
    { question: "Wir waren ___ Stadt und haben einen Schrank gekauft.", answer: "in der" },
    { question: "Das Büro ist ___ dritten Stock.", answer: "im" },
    { question: "Am Wochenende waren wir ___ Freunden.", answer: "bei" },
    { question: "Den Computer habe ich ___ Aldo gekauft.", answer: "bei" },
    { question: "Letztes Jahr war ich ___ Österreich.", answer: "in" },
    { question: "Hasan arbeitet ___ WAFAG.", answer: "bei" }
];
